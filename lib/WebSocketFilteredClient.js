...
var _WebSocketClientWrapper = require('./WebSocketClientWrapper');

var _WebSocketClientWrapper2 = _interopRequireDefault(_WebSocketClientWrapper);
...
var WebSocketFilteredClient = function (_WebSocketClientWrapp) {
    ...
    function WebSocketFilteredClient(ws) {
        ...
        var _this = _possibleConstructorReturn(this, (WebSocketFilteredClient.__proto__ || Object.getPrototypeOf(WebSocketFilteredClient)).call(this, ws));
...
}(_WebSocketClientWrapper2.default);

exports.default = WebSocketFilteredClient;